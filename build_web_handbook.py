...
DIAGRAM_PAGES = {
    "decision": (
        ...
        ("图 3", "防盘队员犯规：已传盘", "防盘队员犯规且已尝试传盘时，依据是否影响比赛决定继续或检查。"),
        ("图 4", "防盘队员犯规：未传盘", "防盘队员犯规且未尝试传盘时的比赛状态与 stall 计数恢复。"),
        ("图 5", "持盘者犯规", "持盘者犯规后的继续比赛、回传及 stall 计数判定。"),
        ("图 6", "防盘违规", "防盘违规和持盘者呼叫违规时的纠正与停赛程序。"),
...
def main() -> None:
    ...
    data = {
        ...
        "terms": [
            ...
            ["防盘队员（marker）", "正在防守持盘队员，并可以对其执行读秒的防守方队员。"],
