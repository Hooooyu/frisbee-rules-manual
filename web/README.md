...
`build_web_handbook.py` 从英文 PDF 的文本层和已核查的翻译缓存生成 `web/data.js`，同时导出两份中文图示为 PNG。页面中的 WFDF 原版文档入口指向 `https://rules.wfdf.sport/resources/`。改动源 PDF 或译文缓存后，重新运行生成脚本即可。
