...
| 9 | 8.5「明显改变飞盘位置」正文 | 18.2.6 | 18.2.5 | 已校正 | 现行 18.2.5 才规定无争议 Travel 后比赛不中断并纠正轴心点 |
| 10 | 10.1「不需要验盘的情况」正文 | 18.2.5.3 | 18.2.4.3 | 已校正 | 现行 18.2.4.3 才规定建立轴心点前不得开始 wind-up / throwing motion |
| 11 | 13.13「界内攻防转换后的轴心脚位置」正文 | 18.2.5.1 | 18.2.4.1 | 已校正 | 现行 18.2.4.1 才规定在错误位置建立轴心点构成 Travel |
| 12 | 17.6「防守方接盘犯规无争议后在进攻得分区取得盘权」正文 | 14.2 | 14.3 | 已校正 | 现行 14.3 才规定未形成得分时移动到最近得分线建立轴心点 |
| 13 | 18.5「双人防守」正文 | 18.1.4 | 18.1.3.1 | 已校正 | 现行 18.1.3.1 明确规定非法站位纠正后才能恢复读秒 |
| 14 | 18.8「防盘违规后防盘队员没有调整读秒」标题 | 18.1.5 | 18.1.4 | 已校正 | 现行 18.1.4 是相关 Marking Violation 处理条款 |
| 15 | 18.9「性质严重的防盘违规」标题 | 18.1.5.3 | 18.1.4.3 | 已校正 | 现行 18.1.4.3 才是 egregious marking infraction |
| 16 | 18.10「跑动接盘减速过程中传盘」标题 | 18.2.2.1 | 18.2.1.1 | 已校正 | 现行 18.2.1.1 是跑动/跳跃接盘后直接出盘的例外 |
| 17 | 18.11「作出走步示意」标题 | 18.2.5 | 18.2.4 | 已校正 | 现行 18.2.4 定义构成 Travel 的各种情形 |
| 18 | 18.11 正文 | 18.2.2.1 | 18.2.1.1 | 已校正 | 与现行跑动接盘直接出盘条款对应 |
| 19 | 18.12「助跑出盘」标题 | 18.2.5.3 | 18.2.4.3 | 已校正 | 与建立轴心点前不得开始掷盘动作对应 |
| 20 | 18.13「拍盘（Tipping）」标题 | 18.2.5.5 | 18.2.4.5 | 已校正 | 现行 18.2.4.5 规定故意 bobble / fumble / delay 以移动属于 Travel |
| 21 | 18.14「走步示意后继续比赛」标题 | 18.2.6 | 18.2.5 | 已校正 | 现行 18.2.5 才是无争议 Travel 后继续比赛的处理程序 |
| 22 | 18.14 正文 | 18.2.6 | 18.2.5¹ | 已校正 | 现行 18.2.5 是该处理程序；如采用最细一级引用，可进一步指向 18.2.5.1 |
| 23 | 18.15「走步违例后的比赛恢复」标题 | 18.2.7 | 18.2.6 | 已校正 | 现行 18.2.6 才规定 Travel 后完成传盘所产生的 Travel Violation 处理 |`;
